...
import { listDir, getFile, putFile, deleteFile, parseFrontmatter, buildFrontmatter } from '../../_lib/github.js';
...
export async function onRequestGet(context) {
  ...
  try {
    const files = await listDir(DIR_MAP[type], env);
    const items = [];
...
export async function onRequestPost(context) {
  ...
  if (!targetPath) {
    ...
    targetPath = `${DIR_MAP[type]}/${slug}.md`;
  }
